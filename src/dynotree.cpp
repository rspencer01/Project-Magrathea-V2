  ...
  for (int i = 1;i<6;i++)
  {
    ...
    Vector3 leafPos = pos + dir*len/6.0*i + leafDir*0.3;
  	...
  	addPoint(numberOfPoints,
             ...
             Vector3(0,1,0),
             0.f,0.7f,0.0f);
    editTextureCoord(numberOfPoints,0.5,0.5);
    numberOfPoints++;
   	addPoint(numberOfPoints,
             leafPos+leafDir/2.0+leafCross,
             Vector3(0,1,0),
             0.f	,0.7f,0.f);
    editTextureCoord(numberOfPoints,0.6,0.5);
    numberOfPoints++;
   	addPoint(numberOfPoints,
             leafPos+leafDir,
             Vector3(0,1,0),
             0.f,0.7f,0.f);
    editTextureCoord(numberOfPoints,0.6,0.6);
    numberOfPoints++;
    ...
    numberOfTriangles++;
   	...
   	addPoint(numberOfPoints,
             ...
             Vector3(0,1,0),
             0.f	,0.7f,0.f);
    editTextureCoord(numberOfPoints,0.5,0.6);
    numberOfPoints++;
