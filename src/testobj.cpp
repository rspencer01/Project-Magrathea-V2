...
TestObj::TestObj(Game* parent) : Object(Vector3(0,0,0),parent)
{
  ...
  addPoint(5,Vector3(-10,10,-5),Vector3(1,0,1),0,0,1);
  addPoint(6,Vector3(10,-10,-5),Vector3(1,0,1),0,0,1);
  addPoint(7,Vector3(10,10,-5),Vector3(1,0,1),0,0,1);
  addTriangle(4,4,5,6);
  addTriangle(5,7,5,6);

  addPoint(8,Vector3(-3,0,3),Vector3(1,0,1),0,0,1);
  addPoint(9,Vector3(-1,0,3),Vector3(1,0,1),0,0,1);
  addPoint(10,Vector3(-2,2,3),Vector3(1,0,1),0,0,1);
